...
var webhookInterface_1 = require("../ui/webhookInterface");
...
var WebhookNest = (function (_super) {
     ...
     * ```
     */
    WebhookNest.prototype.createInterface = function (handleRequest) {
        var wh = this;
        var ui = new webhookInterface_1.WebhookInterface(wh.e, wh, handleRequest);
        this.ui = ui;
        wh.e.addWebhookInterface(ui);
        return ui;
    };
    WebhookNest.prototype.getInterface = function () {
        return this.ui;
    };
    return WebhookNest;
}(nest_1.Nest));
