...
var Tunnel = (function () {
     ...
     * @param callback
     */
    Tunnel.prototype.match = function (pattern, matchingLimit, orphanMinutes, callback) {
    ...
    Tunnel.prototype.executeMatch = function (job, nest) {
        ...
        var tn = this;
        var qjob_pattern_match_result, job_pattern_match_result;
        var matched_jobs = [];
        var job_base, qjob_base;
